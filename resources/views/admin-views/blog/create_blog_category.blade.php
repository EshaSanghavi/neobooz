...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="blog-form text-start" action="{{ route('admin.blog-category-store') }}" method="POST" enctype="multipart/form-data" id="blog_form">
            @csrf
            <div class="card">
                <div class="px-4 pt-3">
            ...
            <div class="row justify-content-end gap-3 mt-3 mx-1">
                ...
                <button type="button" class="btn btn--primary px-5 blog-add-requirements-check">{{ translate('submit') }}</button>
            </div>
        </form>
    </div>
