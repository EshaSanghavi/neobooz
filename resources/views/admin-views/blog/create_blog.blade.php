                    ...
                    @foreach ($languages as $lang)
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="form-group">
                                    ...
                                    <div>
                                        <div class="custom_upload_input" style="height:200px; width:200px;">
                        ...
                        <div class="form-group pt-2">
                            <label class="title-color"
                                    for="{{ $lang }}_seotitle">{{ translate('SEO_Title') }}
                                ({{ strtoupper($lang) }})</label>
                                <input type="text" {{ $lang == $defaultLanguage ? 'required' : '' }} name="seo_title"
                                    id="{{ $lang }}_seotitle" class="form-control" >
                        </div>
