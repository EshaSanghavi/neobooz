                            ...
                            <tr>
                                <td class="__w-45 ">
                                    <div>
                                        ...
                                        <input type="checkbox"  class="form-control" style="height: 22px; width: 22px; margin: 10px 0px;" name="resell_{{ $cartItem['id'] }}" id="resell_{{ $cartItem['id'] }}" onclick="resellInput({{ $cartItem['id'] }})">
                                    </div>
                                </td>
                                <td class="__w-45">
